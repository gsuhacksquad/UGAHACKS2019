 ...
 */
 ...
 //The contact page has been disabled because we didn't want it. It needs to be removed from the nav bar
...
//  res.send('Search Page Incoming')
//})
app.get('/bookingpage', function (req, res){
  res.send('Booking Page Incoming')
})
app.get('/searchpage',searchpageController.index);
